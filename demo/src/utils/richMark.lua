...
local marks = {
    ...
    sprite = {
        mark_func = function( richLabel, value, parse_value )
            ...
            if arg.fileName ~= nil then
                ...
                richLabel:appendSpriteToCurrentLine( sprite, width, height )
            end
        end,
        parse_value_func = defaultParseValue,
    },
	endl = {
        mark_func = function( richLabel, value, parse_value )
            ...
            for i=1,count do richLabel:appendLine() end
        end,
        parse_value_func = defaultParseValue,
    },
    button = {
    ...
    movieclip = {
        mark_func = function( richLabel, value, parse_value )
            ...
            if arg.mcName ~= nil then
                ...
                richLabel:appendSpriteToCurrentLine( mc, width, height, width * 0.5 )
            end
        end,
        parse_value_func = defaultParseValue,
    },
