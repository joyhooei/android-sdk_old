...
class RuleXiaomi(RuleBase):
    ...
    CH_NAME = '小米小包'
    SDKTYPE = '18'
    PACKAGE_NAME = 'com.yunyue.dydh.xiaomi'
...
class RuleUC(RuleBase):
    ...
    CH_NAME = 'UC小包'
    SDKTYPE = '7'
    PACKAGE_NAME = 'com.yunyue.dydh.uc'
...
class RuleBaidu(RuleBase):
    ...
    CH_NAME = '百度小包'
    SDKTYPE = '17'
    PACKAGE_NAME = 'com.yunyue.dydh.baidu'
...
class RuleAnzhi(RuleBase):
    ...
    CH_NAME = '安智小包'
    SDKTYPE = '21'
    PACKAGE_NAME = 'com.yunyue.dydh.anzhi'
...
class RuleC360(RuleBase):
    ...
    CH_NAME = '360小包'
    SDKTYPE = '19'
    PACKAGE_NAME = 'com.yunyue.dydh.c360'
...
class RuleOppo(RuleBase):
    ...
    CH_NAME = 'OPPO小包'
    SDKTYPE = '20'
    PACKAGE_NAME = 'com.yunyue.dydh.nearme.gamecenter'
    YY_PACKAGE_NAME = 'com.yunyue.dydh.oppo'
...
class RuleYYB(RuleBase):
    ...
    CH_NAME = '应用宝小包'
    SDKTYPE = '24'
    PACKAGE_NAME = 'com.tencent.tmgp.DYDHHD'
    YY_PACKAGE_NAME = 'com.yunyue.dydh.yyb'
    APP_NAME = '电影大亨HD'
...
class RuleWDJ(RuleBase):
    ...
    CH_NAME = '豌豆荚小包'
    SDKTYPE = '22'
    PACKAGE_NAME = 'com.yunyue.dydh.wdj'
...
class RuleWanka(RuleBase):
    ...
    CH_NAME = '硬核小包'
    SDKTYPE = '23'
    PACKAGE_NAME = 'com.yunyue.dydh.wanka'
    YY_PACKAGE_NAME = 'com.yunyue.dydh.wanka'
...
class RuleEmpty(RuleBase):
    ...
    CH_NAME = '白包小包'
    SDKTYPE = '0'
    PACKAGE_NAME = 'com.yunyue.dydh.yy'
...
class RuleGfan(RuleBase):
    ...
    CH_NAME = '机锋小包'
    SDKTYPE = '28'
    PACKAGE_NAME = 'com.yunyue.dydh.gfan'
...
class RuleMM(RuleBase):
    ...
    CH_NAME = '移动MM小包'
    SDKTYPE = '29'
    PACKAGE_NAME = 'com.yunyue.dydh.mm'
...
class RuleM4399(RuleBase):
    ...
    CH_NAME = '4399小包'
    SDKTYPE = '30'
    PACKAGE_NAME = 'com.yunyue.dydh.m4399'
...
class RuleHWD(RuleBase):
    ...
    CH_NAME = '好玩点小包'
    SDKTYPE = '27'
    PACKAGE_NAME = 'com.yunyue.dydh.hwd'
...
class RulePaojiao(RuleBase):
    ...
    CH_NAME = '泡椒小包'
    SDKTYPE = '31'
    PACKAGE_NAME = 'com.yunyue.dydh.paojiao'
...
class RulePipaw(RuleBase):
    ...
    CH_NAME = '琵琶网小包'
    SDKTYPE = '32'
    PACKAGE_NAME = 'com.yunyue.dydh.ppw'
    YY_PACKAGE_NAME = 'com.yunyue.dydh.pipaw'
...
class RuleYouku(RuleBase):
    ...
    CH_NAME = '优酷网小包'
    SDKTYPE = '33'
    PACKAGE_NAME = 'com.yunyue.dydh.youku'
...
class RuleYYH(RuleBase):
    ...
    CH_NAME = '应用汇小包'
    SDKTYPE = '34'
    PACKAGE_NAME = 'com.yunyue.dydh.yyh'
...
class RuleZY(RuleBase):
    ...
    CH_NAME = '卓易小包'
    SDKTYPE = '35'
    PACKAGE_NAME = 'com.yunyue.dydh.zy'
...
class RuleKugou(RuleBase):
    ...
    CH_NAME = '酷狗小包'
    SDKTYPE = '36'
    PACKAGE_NAME = 'com.yunyue.dydh.kugou'
...
class RuleEGame(RuleBase):
    ...
    CH_NAME = '电信爱游戏小包'
    SDKTYPE = '37'
    PACKAGE_NAME = 'com.yunyue.dydh.egame'
