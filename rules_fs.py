...
class RuleYYB(RuleBase):
    ...
    YY_PACKAGE_NAME = 'com.yunyue.fs.yyb'
    APP_NAME = '哪吒归来HD'
...
class RuleM4399(RuleBase):
    ...
    CH_NAME = '4399小包'
    SDKTYPE = '30'
    PACKAGE_NAME = 'com.yunyue.fs.m4399'
...
class RuleHWD(RuleBase):
    ...
    CH_NAME = '好玩点小包'
    SDKTYPE = '27'
    PACKAGE_NAME = 'com.yunyue.fs.hwd'
...
class RuleYouku(RuleBase):
    ...
    CH_NAME = '优酷网小包'
    SDKTYPE = '33'
    PACKAGE_NAME = 'com.yunyue.fs.youku'
...
class RuleKugou(RuleBase):
    ...
    CH_NAME = '酷狗小包'
    SDKTYPE = '36'
    PACKAGE_NAME = 'com.yunyue.fs.kugou'
