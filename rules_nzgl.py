...
class RuleZC(RuleBase):
    ...
    PAY_URL = 'http://sdk.nataku.yunyuegame.com/sdk/android/zcgame/pay_callback'
...
class RuleC360(RuleBase):
    ...
    PAY_URL = 'http://sdk.nataku.yunyuegame.com/sdk/android/sdk/c360/pay_callback'
...
class RuleOppo(RuleBase):
    ...
    PAY_URL = 'http://sdk.nataku.yunyuegame.com/sdk/android/sdk/oppo/pay_callback'
...
class RuleMM(RuleBase):
    ...
    PAY_URL = 'http://sdk.nataku.yunyuegame.com/sdk/android/sdk/mm/pay_callback'
...
class RuleYouku(RuleBase):
    ...
    PAY_URL = 'http://sdk.nataku.yunyuegame.com/sdk/android/sdk/youku/pay_callback'
