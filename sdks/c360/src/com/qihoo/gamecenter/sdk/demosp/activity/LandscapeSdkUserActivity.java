...
public class LandscapeSdkUserActivity extends SdkUserBaseActivity implements
        OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_get_contact_content:
                doSdkGetContactContent(mQihooUserInfo, true);
                break;
            case R.id.btn_invite_friend_batch:
                doSdkInviteFriend(mQihooUserInfo, true);
                break;
            case R.id.btn_share:
            ...
            case R.id.btn_invite_friend_by_sdk:
                doSdkInviteFriendBySdk(mQihooUserInfo, true);
                break;
            case R.id.btn_display_rank:
                doSdkDisplayGameFriendRank(mQihooUserInfo, true);
                break;
            ...
            case R.id.btn_quit:
                ...
                break;
            case R.id.btn_pay:
                doSdkPay(mQihooUserInfo, true);
                break;
            case R.id.btn_realnamereg:
                doSdkRealNameRegister(mQihooUserInfo, true);
                break;
