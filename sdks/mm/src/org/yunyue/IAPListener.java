...
public class IAPListener implements OnPurchaseListener {
	...
	private GameProxyImpl context;
	private IAPHandler iapHandler;

	public IAPListener(GameProxyImpl context, IAPHandler iapHandler) {
	...
	public void onBillingFinish(int code, HashMap arg1) {
		...
		if (code == PurchaseCode.ORDER_OK || (code == PurchaseCode.AUTH_OK) ||(code == PurchaseCode.WEAK_ORDER_OK)) {
            ...
            context.payCallBack.onSuccess(null);
		} else {
			/**
			 * 表示订购失败。
			 */
			result = "订购结果：" + Purchase.getReason(code);
            context.payCallBack.onFail(null);
		}
