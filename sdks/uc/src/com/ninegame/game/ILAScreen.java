...
public interface ILAScreen extends OnTouchListener, OnKeyListener,
		OnClickListener, OnFocusChangeListener, OnCreateContextMenuListener,
		OnLongClickListener {
	...
	public abstract void beforeDraw(SurfaceView view);
}